...
#define BUZZER                       1000 //    OFF, ON, n. Where n=100..6000 (Hz freq.) for piezo speaker. ON for buzzer.    Option
...
#define AXIS1_STEPS_PER_WORMROT    128000 //      0, n. Number steps per worm rotation (PEC Eq mode only, 0 disables PEC.)   <-Req'd
...
#define AXIS3_SLEW_RATE_DESIRED       8.0 //    1.0, n, (degrees/second) Maximum speed depends on processor.                  Adjust
...
#define AXIS4_STEPS_PER_MICRON       0.75 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
...
#define AXIS4_LIMIT_MAX                39 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust
